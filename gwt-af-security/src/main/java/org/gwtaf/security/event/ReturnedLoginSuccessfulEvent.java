 ...
 */
public class ReturnedLoginSuccessfulEvent extends
		GenericPayloadEvent<User, ReturnedLoginSuccessfulEventHandler> {
	 ...
	 */
	@Inject
	public ReturnedLoginSuccessfulEvent(Type<ReturnedLoginSuccessfulEventHandler> type) {
		super(type);
	}

	@Override
	protected void dispatch(ReturnedLoginSuccessfulEventHandler handler) {
