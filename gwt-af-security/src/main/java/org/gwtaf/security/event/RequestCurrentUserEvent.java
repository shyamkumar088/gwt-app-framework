 ...
 */
public class RequestCurrentUserEvent extends
		GenericEvent<RequestCurrentUserEventHandler> {
	 ...
	 */
	@Inject
	public RequestCurrentUserEvent(Type<RequestCurrentUserEventHandler> type) {
		super(type);
	}

	@Override
	protected void dispatch(RequestCurrentUserEventHandler handler) {
