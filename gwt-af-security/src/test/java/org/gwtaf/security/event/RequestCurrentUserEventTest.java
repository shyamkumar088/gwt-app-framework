...
/**
 * Unit test the {@link RequestCurrentUserEvent} class.
 * 
 * @author Arthur Kalmenson
 */
public class RequestCurrentUserEventTest {

	@Mock
	private RequestCurrentUserEventHandler handlerMock;

	@Mock
	private Type<RequestCurrentUserEventHandler> type;
	
	private RequestCurrentUserEvent event;

	@BeforeMethod
	public void initBefore() {
		MockitoAnnotations.initMocks(this);
		event = new RequestCurrentUserEvent(type);
	}
