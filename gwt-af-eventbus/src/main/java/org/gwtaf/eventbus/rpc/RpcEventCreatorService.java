...
/**
 * An interface for a service that will be responsible for creating
 * {@link RpcEvent}s.
 * 
 * @author Jason Kong
 * 
 */
public abstract class RpcEventCreatorService {
	 ...
	 */
	public RpcEventCreatorService(EventBus eventBus,
	...
	protected <R extends Response, A extends Action<R>> void fireStandardRpc(
		...
		// fire off the rpc event for search
