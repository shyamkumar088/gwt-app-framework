 ...
 */
public class ReturnedLoginFailedEvent extends
		GenericPayloadEvent<String, ReturnedLoginFailedEventHandler> {
	 ...
	 */
	@Inject
	public ReturnedLoginFailedEvent(Type<ReturnedLoginFailedEventHandler> type) {
		super(type);
	}

	@Override
	protected void dispatch(ReturnedLoginFailedEventHandler handler) {
